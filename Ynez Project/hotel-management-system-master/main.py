...
#C:/Users/Ynez Dias/OneDrive/Desktop/Ynez Project/hotel-management-system-master
#os.chdir("C:/Users/Ynez Dias/OneDrive/Desktop/Ynez Project/hotel-management-system-master")
#os.chdir('C:\Users\Ynez Dias\OneDrive\Desktop\Ynez Project\hotel-management-system-master')
...
Label(sroot,text="Ynez Dias",font='Timesnewroman 40 ',bg='white',fg='grey').place(x=535,y=180)
Label(sroot,text="Ynezdias0501@gmail.com",font='Timesnewroman 40',bg='white',fg='grey').place(x=535,y=270)
...
def mainroot():
	...
	path = os.path.normpath("images/newestbg5.jpg")
	...
	#-----------------------------------------------------------------
		nl = Label(b_frame,text='Made by Ynez and Lyris',fg='black',bg='gray91',font='msserif 8')
	...
	def staff():
		...
		Label(emp1inf,text="Mr. Dewain Diago",bg='white',fg="Grey",font='msserif 10').place(x=60,y=37)
		...
		Label(emp1inf,text="Ms. Ynez Dias",bg='white',fg="Grey",font='msserif 10').place(x=45,y=37)
		...
		Label(emp1inf,text="Mr.Shane Coelho (Head)",bg='white',fg="Grey",font='msserif 10').place(x=72,y=37)
		...
		Label(emp1inf,text="Ms. Lyris Dsilva (Head)",bg='white',fg="Grey",font='msserif 10').place(x=55,y=37)
	...
	def rooms():
		...
		'''loop approach will fail when we connect database with button hence the code'''
		b1  = Button(b_frame,font='mssherif 10', text="Room 1", bg='white',fg='cyan4',width=10,command=lambda:roomdet(1))
