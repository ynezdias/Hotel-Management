...
def mainroot():
	...
	def staff():
		...
		Label(emp1inf,text="Mr.Shane Coelho",bg='white',fg="Grey",font='msserif 10').place(x=60,y=37)
		...
		Label(emp1inf,text="Ms. Lyris Dsilva",bg='white',fg="Grey",font='msserif 10').place(x=45,y=37)
		...
		Label(emp1inf,text="Ms.Ynez Dias (Head)",bg='white',fg="Grey",font='msserif 10').place(x=72,y=37)
		...
		Label(emp1inf,text="Mr. Dewain Diago",bg='white',fg="Grey",font='msserif 10').place(x=55,y=37)
	...
	def rooms():
		...
		'''loop approach will fail when we connect database with button hence the huge code'''
		b1  = Button(b_frame,font='mssherif 10', text="Room 1", bg='white',fg='cyan4',width=10,command=lambda:roomdet(1))
